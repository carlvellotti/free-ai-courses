...
4. Understand how to paste images into Codex (Ctrl+V - critical!)
...
With Codex? We'll do it in 2 minutes.
...
Find it in: meeting-notes-raw.md
...
**Go look at it in your editor!** You should see it in the  folder.
...
**Go look at it in your editor!** It should be in the  folder.
...
Normally you'd write up feedback manually. But with Codex, you can paste the screenshot and get instant analysis.
...
2. In Codex terminal: Press **Ctrl+V** (even on Mac!)
3. The image appears in the conversation
4. Ask me to analyze it

STOP: Ask users if they understand how to copy and paste images into Codex.
...
6. Come back to this Codex chat
...
With Codex's web search? We'll get you research-backed solutions in 2 minutes.
...
A: "They'll be stored in the .codex/output-styles/ folder (we'll explore that folder structure in later modules). For now, just know that once created, I remember them for future use."

...
> **Start this lesson interactively:** Type `start-1-5` in Codex to meet your specialist team and see them review a feature spec.
...
Start it by typing `start-1-6` in Codex, or read the reference guide:

...
> **Start this lesson interactively:** Type `start-1-6-codex` in Codex to see how AGENTS.md shapes everything Codex produces.
...
Start it by typing `start-2-1-codex` in Codex, or read the reference guide:

...
> **Start this lesson interactively:** Type `start-1-1` in your Codex terminal session to begin the guided lesson.
...
1. **Interactive lessons** (what you're doing now). Each lesson is started by typing a skill name into Codex — for example, `start-1-2` begins the next lesson. Codex then guides you step-by-step, and you actually do the work.
...
Start it by typing `start-1-2` in Codex, or read the reference guide:

...
- **Prerequisites:** Codex installed (Pro or Max subscription), course folder open in your terminal

> **Start this lesson interactively:** Type `start-1-1-codex` in your Codex terminal session to begin the guided lesson.
...
**Key takeaway:** You don't need to know how to code or memorize terminal commands. You talk to Codex in plain English, and it does the work. The whole course happens inside Codex itself.
...
1. **Interactive lessons** (what you're doing now). Each lesson is started by typing a skill name into Codex — for example, `start-1-2-codex` begins the next lesson. Codex then guides you step-by-step, and you actually do the work.
...
- Full course: roughly 20-30 hours, fully self-paced
...
**You need:**
- A Codex Pro or Max subscription (you already have this)
- A willingness to try things — you learn by doing

**You don't need:**
- Coding skills — this is for PMs, not engineers
- Terminal command knowledge — you just talk to Codex in plain English; it runs any commands behind the scenes
- Your own documents — all files are pre-created for you

> **A note on permissions:** As Codex works, it occasionally runs terminal commands to read files or set things up. You may see permission prompts. It's safe to approve them — clicking "Yes, and don't ask again" makes the rest of the course smoother.
...
Start it by typing `start-1-2-codex` in Codex, or read the reference guide:

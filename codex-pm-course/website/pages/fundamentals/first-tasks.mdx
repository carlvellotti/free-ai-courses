...
> **Start this lesson interactively:** Type `start-1-3` in Codex to work through all five scenarios hands-on.
...
Start it by typing `start-1-4` in Codex, or read the reference guide:

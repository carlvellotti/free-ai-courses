...
> **Start this lesson interactively:** Type `start-1-3-codex` in Codex to work through all five scenarios hands-on.
...
> **Critical:** To paste an image into the Codex terminal, use **Ctrl+V** — even on a Mac. `Cmd+V` does not work in the terminal. This is the single most common beginner mistake.
...
2. In Codex, press **Ctrl+V**. The image appears in the conversation.
...
Start it by typing `start-1-4-codex` in Codex, or read the reference guide:

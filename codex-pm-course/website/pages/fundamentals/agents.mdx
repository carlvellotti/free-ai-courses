...
> **Start this lesson interactively:** Type `start-1-4` in Codex to watch agents process work in parallel.
...
Start it by typing `start-1-5` in Codex, or read the reference guide:

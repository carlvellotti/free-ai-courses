...
**This course is taught entirely inside the Codex app.** You'll download the app, paste one setup prompt, and Codex itself becomes your instructor — guiding you through each lesson interactively, right where you'll be doing the work.

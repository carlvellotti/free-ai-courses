...
description: 'Learn what OpenAI Codex is, what it does for Product Managers, and how this free course teaches Codex inside Codex itself.'
keywords: 'codex, openai codex, codex for product managers, codex tutorial, codex cli, AI for PMs, codex pm course'
---
...
**Codex is OpenAI's AI coding agent** — a tool that lives in your terminal (and your editor) and does real work with your files when you ask it in plain English. It reads documents, writes and edits them, analyzes data, and runs multi-step tasks for you.

You don't need to be an engineer to use it. If you can describe what you want, Codex can do it.

**This course is taught entirely inside Codex.** You'll install Codex, download the course files, and Codex itself becomes your instructor — guiding you through each lesson interactively, right where you'll be doing the work.
...
**No coding or terminal experience required.** You'll learn the handful of commands you need as you go.
...
| Surface | What it is |
|---------|-----------|
| **Codex CLI** | The agent in your terminal. This is where the course happens. |
| **IDE extension** | Codex inside VS Code, Cursor, and Windsurf. |
| **Cloud / Web** | Runs tasks in the cloud at chatgpt.com/codex. |
| **ChatGPT** | Bundled into ChatGPT plans, plus integrations like code review. |
...
- **It's reviewable** — Codex shows a transcript of everything it does, and changes can be rolled back.
...
1. **Interactive lessons (the main event)** — You run a lesson inside Codex and it teaches you step by step while you do real work. You learn by doing, not by watching videos.
...
**Next: Module 0.2 — Installing Codex.** You'll install the Codex CLI, sign in with your ChatGPT account, and get ready to run your first lesson.

**[Go to Module 0.2: Installing Codex →](/getting-started/installation)**

## 📚 Resources

- [OpenAI Codex](https://openai.com/codex/) — product overview
- [Codex CLI docs](https://developers.openai.com/codex/cli/) — install and sign-in

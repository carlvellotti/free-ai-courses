...
> **Start this lesson interactively:** Type `start-2-2` in Codex to work through the full discovery-to-decision data workflow.
...
Start it by typing `start-2-3` in Codex, or read the reference guide:

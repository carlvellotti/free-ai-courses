...
> **Start this lesson interactively:** Type `start-2-3` in Codex to develop a complete AI product strategy through guided choices.
...
Start it by typing `start-3-1` in Codex, or read the reference guide:

...
> **Start this lesson interactively:** Type `start-2-3-codex` in Codex to develop a complete AI product strategy through guided choices.
...
Start it by typing `start-4-1-codex` in Codex, or read the reference guide:

...
> **Start this lesson interactively:** Type `start-2-1-codex` in Codex to write a real PRD step-by-step.
...
Start it by typing `start-2-2-codex` in Codex, or read the reference guide:

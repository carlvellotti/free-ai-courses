...
> **Start this lesson interactively:** Type `start-4-2-codex` in Codex to define your quiz through a guided interview.
...
Start it by typing `start-4-3-codex` in Codex, or read the reference guide:

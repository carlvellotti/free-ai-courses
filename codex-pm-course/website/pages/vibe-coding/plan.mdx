...
> **Start this lesson interactively:** Type `start-3-2` in Codex to define your quiz through a guided interview.
...
Start it by typing `start-3-3` in Codex, or read the reference guide:

...
> **Start this lesson interactively:** Type `start-4-3-codex` in Codex to build and refine your quiz.
...
The fastest way to request changes is visual. Take a screenshot, paste it into Codex with **Ctrl+V** (not `Cmd+V`, even on Mac), and describe what you want different. This also works great for showing bugs — if something looks wrong, screenshot it and paste it.
...
Start it by typing `start-4-4-codex` in Codex, or read the reference guide:

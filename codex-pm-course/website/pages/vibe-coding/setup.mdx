...
> **Start this lesson interactively:** Type `start-4-1-codex` in Codex to set up your build project.
...
Start it by typing `start-4-2-codex` in Codex, or read the reference guide:

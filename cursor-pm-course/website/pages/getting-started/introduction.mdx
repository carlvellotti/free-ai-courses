...
- Paste one prompt into Cursor's Agents view and the AI sets up the course for you
...
- 0.2: Installing Cursor
- 0.3: Starting the course
...
You'll download Cursor, create an account, and activate your Pro trial. Then Module 0.3 sets up the course with one pasted prompt.

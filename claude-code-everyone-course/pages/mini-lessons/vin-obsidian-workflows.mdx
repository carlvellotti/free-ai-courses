...
Then run: fspm get vin-obsidian-workflows
Then tell me how to begin.`} />

Claude installs the lesson into your project; type `/start-vin-obsidian-workflows` to begin.

> **Prefer the terminal?** The same prompt works in Claude Code in your terminal, or run `fspm get vin-obsidian-workflows` yourself after installing the CLI from [fullstackpm.com/cli](https://fullstackpm.com/cli).

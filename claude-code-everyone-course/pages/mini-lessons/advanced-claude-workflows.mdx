...
Then run: fspm get advanced-claude-workflows
Then tell me how to begin.`} />

Claude installs the lesson into your project; type `/start-advanced-claude-workflows` to begin.

> **Prefer the terminal?** The same prompt works in Claude Code in your terminal, or run `fspm get advanced-claude-workflows` yourself after installing the CLI from [fullstackpm.com/cli](https://fullstackpm.com/cli).
...
**Get the lesson:** paste the prompt above into the Claude Desktop app.

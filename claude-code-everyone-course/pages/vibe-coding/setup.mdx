...
If you don't have the course files yet, go back to the [Module Overview](/vibe-coding#get-the-course-materials) for setup instructions - one pasted prompt installs everything.
